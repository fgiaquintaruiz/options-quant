...
public class C6ReversalCallStrategy implements TradingStrategy {
    ...
    public boolean isTriggered(String ticker, StrategyData data, ZonedDateTime currentTime) {
        ...
        // =========================================================================
        // RULE 1: CLEAR DOWNTREND (Suffocation Filter on 1H)
        // Price must have closed BELOW SMA20 for at least the 3 prior hours.
        // =========================================================================
        ...
        // NEW FILTER: Candle must close in its top 35% (no long upper wicks)
        ...
        // VOLUME FILTER: Breakout volume must be decent (>= 90% of average)

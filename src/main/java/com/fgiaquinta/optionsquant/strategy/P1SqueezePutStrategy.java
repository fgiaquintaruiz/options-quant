    ...
    public boolean isTriggered(String ticker, StrategyData data, ZonedDateTime currentTime) {
        ...
        final List<Condition> conditions = List.of(
            ...
            new Condition() {
                ...
                @Override public String label() { return "Breakout bajista con buffer"; }
            ...
            new Condition() {
                ...
                @Override public String label() { return "Vela bajista en 15m"; }
            ...
            new Condition() {
                ...
                @Override public String label() { return "Precio riding lower BB 15m"; }

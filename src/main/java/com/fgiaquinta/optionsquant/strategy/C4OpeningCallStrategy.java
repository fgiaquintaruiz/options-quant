...
public class C4OpeningCallStrategy implements TradingStrategy, TimeframeRequirements {
    ...
    public boolean isTriggered(String ticker, StrategyData data, ZonedDateTime currentTime) {
        ...
        final List<Condition> conditions = List.of(
            ...
            new Condition() {
                @Override public boolean test() { return isExtremeGapDown && gapInRange; }
                @Override public String label()  { return "Apertura con salto, precio en zona de sobrecompra"; }
            ...
            new Condition() {
                @Override public boolean test() { return isGreenCandle; }
        ...
        return ConditionEvaluator.evaluate("[C4]", ticker, currentTime, conditions, log);
    }
}

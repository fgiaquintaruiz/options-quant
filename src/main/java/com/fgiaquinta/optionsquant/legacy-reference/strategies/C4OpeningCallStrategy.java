...
public class C4OpeningCallStrategy implements TradingStrategy {
    ...
    public boolean isTriggered(String ticker, DataManager dataManager, ZonedDateTime currentTime) {
        ...
        // =========================================================================
        // REGLA 2: LA ZONA DE ORO DEL SALTO (GAP DOWN)
        // =========================================================================

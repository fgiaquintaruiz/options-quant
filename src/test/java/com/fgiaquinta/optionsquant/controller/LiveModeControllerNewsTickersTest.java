...
class LiveModeControllerNewsTickersTest {
    ...
    @Test
    @DisplayName("getNewsTickers → 200 OK with empty list (TWS integration not yet wired)")
    void getNewsTickers_returns200WithEmptyList() {
        ResponseEntity<List<Map<String, Object>>> res = controller.getNewsTickers();
    ...
    @Test
    @DisplayName("getNewsTickers → body is non-null and contains zero entries")
    void getNewsTickers_bodyIsNonNullAndEmpty() {
        List<Map<String, Object>> body = controller.getNewsTickers().getBody();

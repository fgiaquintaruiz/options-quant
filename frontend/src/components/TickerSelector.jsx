...
export const DEFAULT_GROUPS = [
  ...
  { id: 'all',        label: 'All (Rest of World)', tickers: 'A,AAL,AAPL,ABBV,ABNB,ABT,ACGL,ACN,ADBE,ADI,ADM,ADP,ADSK,AEE,AEP,AES,AFG,AFL,AFRM,AIG,AIZ,AJG,AKAM,ALB,ALGN,ALL,ALLE,AMAT,AMCR,AMD,AMDL,AME,AMGN,AMP,AMT,AMZN,ANET,AON,AOS,APA,APD,APH,APTV,ARE,ARKK,ARM,ATO,AVB,AVGO,AVY,AWK,AXON,AXP,AYI,AZO,BA,BABA,BAC,BALL,BAX,BBWI,BBY,BDX,BEN,BG,BIIB,BIO,BITX,BK,BKNG,BKR,BLDR,BLK,BMY,BR,BSX,BWA,BX,BYND,C,CAG,CAH,CARR,CAT,CB,CBOE,CBRE,CCI,CCL,CDNS,CDW,CE,CEG,CF,CFG,CHD,CHRW,CHTR,CI,CINF,CL,CLX,CMCSA,CME,CMG,CMI,CMS,CNC,CNP,COF,COIN,COO,COP,COR,COST,CPAY,CPB,CPRT,CPT,CRL,CRM,CRWD,CSGP,CSX,CTAS,CTRA,CTSH,CTVA,CVNA,CVS,CVX,CZR,D,DAL,DD,DDOG,DE,DECK,DELL,DG,DGX,DHI,DHR,DIA,DIS,DLR,DLTR,DOC,DOV,DOW,DPZ,DRI,DTE,DUK,DVA,DVN,DXCM,EA,EBAY,ECL,ED,EFX,EG,EIX,EL,ELV,EMN,EMR,ENPH,EOG,EPAM,EQIX,EQT,ERIE,ES,ESS,ETN,ETR,ETSY,EVRG,EW,EXC,EXPD,EXPE,EXR,F,FANG,FAST,FCX,FDS,FDX,FE,FFIV,FICO,FIS,FITB,FMC,FOX,FOXA,FRT,FSLR,FTNT,FTV,GD,GE,GEHC,GEN,GEV,GILD,GIS,GL,GLW,GM,GNRC,GOOG,GOOGL,GPN,GRMN,GS,GWW,HAL,HAS,HBAN,HCA,HD,HIG,HII,HLT,HOLX,HON,HOOD,HPE,HPQ,HRL,HSIC,HST,HSY,HUBB,HUM,HWM,IBM,ICE,IDXX,IEX,IFF,ILMN,INCY,INTC,INTU,INVH,IP,IQV,IR,IRM,ISRG,IT,ITW,IVZ,IWM,J,JBHT,JBL,JCI,JD,JKHY,JNJ,JPM,KDP,KEY,KEYS,KHC,KIM,KLAC,KMB,KMI,KMX,KO,KR,KVUE,L,LDOS,LEN,LH,LHX,LIN,LKQ,LLY,LMT,LNC,LOW,LRCX,LULU,LUV,LVS,LW,LYB,LYV,MA,MAA,MAR,MAS,MCD,MCHP,MCK,MCO,MDB,MDLZ,MDT,MET,META,METP,MGM,MHK,MKC,MKTX,MLM,MMM,MNST,MO,MOH,MOS,MPC,MPWR,MRK,MRNA,MS,MSFT,MSI,MSTR,MTB,MTCH,MTD,MU,NCLH,NDAQ,NDSN,NEE,NEM,NFLX,NI,NIO,NKE,NORW,NSC,NTAP,NTRS,NUE,NVDA,NVO,NVR,NWS,NWSA,NXPI,O,ODFL,OKE,OKLO,OMC,ON,ORCL,ORLY,OTIS,OXY,PANW,PAYC,PAYX,PCAR,PCG,PDD,PEG,PEP,PFE,PFG,PG,PGR,PH,PHM,PKG,PLD,PLTR,PM,PNC,PNR,PNW,PODD,POOL,PPG,PPL,PRU,PSA,PSX,PTC,PWR,PYPL,QCOM,QQQ,QRVO,RCL,REG,REGN,RF,RIOT,RIVN,RJF,RL,RMD,ROL,ROP,ROST,RSG,RTX,RVTY,SBAC,SBUX,SCHW,SHOP,SHW,SJM,SLB,SMCI,SNA,SNPS,SO,SOXL,SPG,SPGI,SPY,SRE,STE,STLD,STT,STX,STZ,SWK,SWKS,SYK,SYY,T,TAP,TDG,TDY,TECH,TEL,TER,TFC,TFX,TGT,TJX,TMO,TMUS,TNA,TPR,TQQQ,TRGP,TRMB,TROW,TRV,TSCO,TSLA,TSM,TSN,TT,TTWO,TXN,TXT,TYL,UAL,UDR,UHS,ULTA,UNH,UNP,UPS,UPST,URA,URI,USB,V,VICI,VLO,VMC,VRSK,VRSN,VRTX,VST,VTR,VZ,WAB,WAT,WBD,WDC,WEC,WELL,WFC,WHR,WM,WMB,WMT,WRB,WST,WTW,WY,WYNN,XEL,XOM,XPEV,XYL,XYZ,YUM,ZBH,ZBRA,ZTS' },
]
 ...
 */
export function expandTickerEntries(entries, groups) {
  const seen   = new Set()
  const result = []
...
export function resolveTickerEntries(value, groups) {
  ...
  return expandTickerEntries(entries, groups).join(',')
}
...
export default function TickerSelector({ value, onChange, disabled, scope, onScopeChange, hotTickers = [] }) {
  ...
  const resolvedTickers = useMemo(() => expandTickerEntries(entries, groups), [entries, groups])
